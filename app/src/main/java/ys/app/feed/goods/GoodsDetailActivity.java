 ...
 * 商品详情
 */
public class GoodsDetailActivity extends FragmentActivity implements View.OnClickListener , GoodsFragment.CallBackValue {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_buy_goods_detail);
