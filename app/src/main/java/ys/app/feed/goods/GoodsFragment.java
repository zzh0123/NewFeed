...
public class GoodsFragment extends LazyFragment implements View.OnClickListener {
    ...
    private ArrayList<GroupPersonNumItem> list_groupPersonNumItem = new ArrayList<GroupPersonNumItem>();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.ll_single_buy: // 单独购买按钮
                ...
                intent1.putExtra("reduceFreightCount", reduceFreightCount);
