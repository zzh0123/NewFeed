...
import ys.app.feed.scoreexchange.ScoreExchangeGoodsFragment;
import ys.app.feed.utils.LogUtils;

/**
 * 0元砍价商品详情
 */
public class ZeroBargainGoodsDetailActivity extends FragmentActivity implements View.OnClickListener , ZeroBargainGoodsFragment.CallBackValue {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zero_bargain_goods_detail);
    ...
    private void initView() {
        ...
        ZeroBargainGoodsFragment zeroBargainGoodsFragment = new ZeroBargainGoodsFragment();
        Bundle bundle = new Bundle();
        bundle.putString("commodityId", commodityId);
        bundle.putString("classType", classType);
        zeroBargainGoodsFragment.setArguments(bundle);
        ...
        fragment_list.add(zeroBargainGoodsFragment);
