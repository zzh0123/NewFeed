...
import ys.app.feed.order.ZeroBargainOrderActivity;
...
public class ZeroBargainGoodsFragment extends LazyFragment implements View.OnClickListener {
    ...
    // 最小购买量
    private Integer scoreCapacityCount = 1;

    private Handler handler;

    public ZeroBargainGoodsFragment() {
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_zero_bargain_goods);
    ...
    private void initView() {
        ...
        header = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_zero_bargain_goods_header, (ViewGroup) findViewById(android.R.id.content), false);
            ...
            public void onResponse(Object response) {
                if (response != null) {
                    ...
                    if (resultInfo.getCode() == 800) {
                        ...
                        // 价格
                        price = data_jsonObject.getDouble("price"); // 原价
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_to_buy: // 单独购买按钮
                Intent intent1 = new Intent(getActivity(), ZeroBargainOrderActivity.class);
