 ...
 * 积分兑换商品详情
 */
public class ScoreExchangeGoodsDetailActivity extends FragmentActivity implements View.OnClickListener , ScoreExchangeGoodsFragment.CallBackValue {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_exchange_goods_detail);
    ...
    private void initView() {
        ...
        ScoreExchangeGoodsFragment scoreExchangeGoodsFragment = new ScoreExchangeGoodsFragment();
        Bundle bundle = new Bundle();
        bundle.putString("commodityId", commodityId);
        bundle.putString("classType", classType);
        scoreExchangeGoodsFragment.setArguments(bundle);
        ...
        fragment_list.add(scoreExchangeGoodsFragment);
