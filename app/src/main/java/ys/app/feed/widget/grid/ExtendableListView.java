...
package ys.app.feed.widget.grid;
...
public abstract class ExtendableListView extends AbsListView {
    ...
    // Layout using our set_default existing state
    ...
    // blocker for when we're in a bottom_group_buy_person_num pass
     ...
     * This is used to bottom_group_buy_person_num the children during a bottom_group_buy_person_num pass.
     */
    ...
    public ExtendableListView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        // start our bottom_group_buy_person_num mode drawing from the top
...
//                }
    ...
    private boolean onTouchMove(final MotionEvent event) {
        ...
        // our data's changed so we need to do a bottom_group_buy_person_num before moving any further
        if (mDataChanged) {
            layoutChildren();
        }
...
//            case TOUCH_MODE_OVERSCROLL:
     ...
     *
     * @return the left location to bottom_group_buy_person_num the child for the given position
     */
     ...
     *
     * @return the top location to bottom_group_buy_person_num the child for the given position
     */
     ...
     *
     * @return the bottom location to bottom_group_buy_person_num the child for the given position
     */
    ...
    class RecycleBin {
        ...
        /**
         * Views that were on screen at the start of bottom_group_buy_person_num. This array is populated at the start of
         * bottom_group_buy_person_num, and at the end of bottom_group_buy_person_num all view in mActiveViews are moved to mScrapViews.
        ...
        void setCacheColorHint(int color) {
            ...
            // Just in case this is called during a bottom_group_buy_person_num pass
            final View[] activeViews = mActiveViews;
            final int count = activeViews.length;
            for (int i = 0; i < count; ++i) {
                final View victim = activeViews[i];
     ...
     * of the view to select during the next bottom_group_buy_person_num.
     */
