...
public class StaggeredGridView extends ExtendableListView {
    ...
    private void preLayoutChildren() {
        // on a major re-bottom_group_buy_person_num reset for our next bottom_group_buy_person_num pass
        if (!mNeedSync) {
        ...
        // since we're going to redo a bottom_group_buy_person_num pass that will draw down from
        // the top
        System.arraycopy(mColumnTops, 0, mColumnBottoms, 0, mColumnCount);
    }

    // NOTE : Views will either be bottom_group_buy_person_num out via onLayoutChild
    // OR
    ...
    private void layoutGridChild(final View child, final int position,
        ...
        // view's bottom_group_buy_person_num params
        ...
        // subtract the margins before bottom_group_buy_person_num
     ...
     * mSyncPosition - the following bottom_group_buy_person_num request will then
     * bottom_group_buy_person_num the that position and then fillUp and fillDown appropriately.
     */
