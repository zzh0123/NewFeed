 ...
 */
public class CouponOrderSelectAdapter extends RecyclerView.Adapter<CouponOrderSelectAdapter.ViewHolder> {
    ...
    public ArrayList<CouponOrderSelectItem> list_coupon = null;
    public String type;
    public Context context;
    private ItemClickCallBack clickCallBack;

    public CouponOrderSelectAdapter(Context context, ArrayList<CouponOrderSelectItem> list_coupon, String type) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder,final int position) {
        ...
        if (TextUtils.equals("018004", type)){
