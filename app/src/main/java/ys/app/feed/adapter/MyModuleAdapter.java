 ...
 */
public class MyModuleAdapter extends RecyclerView.Adapter<MyModuleAdapter.ViewHolder> {
    ...
    public MyModuleAdapter(ArrayList<ModuleItem> list_module) {
        this.list_module = list_module;
    }
    //创建新View，被LayoutManager所调用
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_module_my,viewGroup,false);
