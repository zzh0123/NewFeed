...
public class ZeroBargainOrderFragment extends LazyFragment {
    ...
    public ZeroBargainOrderFragment() {
...
//                initView();
        ...
        setContentView(R.layout.fragment_order_zero_bargain);
    ...
    private void initView() {
        ...
        adapter_order.setClickCallBack(new OrderAdapter.ItemClickCallBack() {
            @Override
            public void onItemClick(int pos) {
                orderId= list_order.get(pos).getOrderId();
                Intent intent = new Intent(getActivity(), ZeroBargainDetailActivity.class);
    ...
    private void setTitleList() {
       ...
       // 订单状态: 0.砍价中 | 1.配货中 | 2.待签收 | 3.已完成 | 4.待评价 | 5.已关闭 | 6.已删除
        ...
        normalOrderStatusItem1.setStatus_name("配货中");
        ...
        normalOrderStatusItem2.setStatus_name("待签收");
        ...
        normalOrderStatusItem3.setStatus_name("已完成");
...
//        normalOrderStatusItem4.setStatus_name("待评价");
...
//        normalOrderStatusItem5.setStatus_name("已关闭");
...
//        normalOrderStatusItem6.setStatus_name("已删除");
