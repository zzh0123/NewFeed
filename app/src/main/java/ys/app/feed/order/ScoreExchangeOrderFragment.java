...
public class ScoreExchangeOrderFragment extends LazyFragment {
    ...
    public ScoreExchangeOrderFragment() {
...
//                initView();
        ...
        setContentView(R.layout.fragment_order_score_exchange);
    ...
    private void initView() {
        ...
        adapter_order.setClickCallBack(new OrderAdapter.ItemClickCallBack() {
            ...
            public void onItemClick(int pos) {
                ...
                Intent intent = new Intent(getActivity(), ScoreExchangeOrderDetailActivity.class);
