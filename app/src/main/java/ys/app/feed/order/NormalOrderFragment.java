...
public class NormalOrderFragment extends LazyFragment {
...
//                initView();
        ...
        setContentView(R.layout.fragment_order_normal);
    ...
    private void initView() {
        // 普通订单列表
        mRecyclerView = (XRecyclerView) this.findViewById(R.id.recyclerview_to_be_paid);
        ...
        adapter_order.setClickCallBack(new OrderAdapter.ItemClickCallBack() {
            ...
            public void onItemClick(int pos) {
                ...
                Intent intent = new Intent(getActivity(), NormalOrderDetailActivity.class);
    ...
    private void setTitleList() {
        // 普通订单表
        // 订单状态: 0.待支付 | 1.配货中 | 2.待签收 | 3.已完成 | 4.待评价 | 5.已关闭 | 6.已删除
