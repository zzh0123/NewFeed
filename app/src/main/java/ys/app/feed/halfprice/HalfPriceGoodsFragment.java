...
import ys.app.feed.order.HalfPriceOrderActivity;
...
public class HalfPriceGoodsFragment extends LazyFragment implements View.OnClickListener {
    ...
    private Double halfPrice; // 半价
    private Double directPrice; // 原价
    private Double halFreight; // 半价运费
    ...
    protected void onCreateViewLazy(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_half_price_goods);
    ...
    private void initView() {
        ...
        header = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_half_price_goods_header, (ViewGroup) findViewById(android.R.id.content), false);
        ...
        tv_price.setText("¥" + halfPrice + "");
        tv_original_price.setText("¥" + directPrice + "");
        tv_full_reduce.setText("含运费： " + halFreight);
        // 规格
            ...
            public void onResponse(Object response) {
                if (response != null) {
                    ...
                    if (resultInfo.getCode() == 800) {
                        ...
                        // 价格
                        halfPrice = data_jsonObject.getDouble("halfPrice"); // 团购价
                        directPrice = data_jsonObject.getDouble("directPrice"); // 原价
                        halFreight = data_jsonObject.getDouble("halFreight"); // 半价运费

                        // 规格
                        goods_name = data_jsonObject.getString("name");

                        // 限制购买量
                        halfRestrictCount = data_jsonObject.getInteger("halfRestrictCount");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.iv_isCollection: // 收藏
                commodityCollection();
                break;
            case R.id.tv_to_buy: // 半价购买按钮
                Intent intent1 = new Intent(getActivity(), HalfPriceOrderActivity.class);
                intent1.putExtra("commodityId", commodityId);
                intent1.putExtra("halfRestrictCount", halfRestrictCount);
                intent1.putExtra("station", station);
                intent1.putExtra("listImg", listImg);
                intent1.putExtra("goods_name", goods_name);
                intent1.putExtra("halfPrice", halfPrice);
                intent1.putExtra("halFreight", halFreight);
