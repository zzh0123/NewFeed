 ...
 * 订单详情（积分）
 */
public class ScoreExchangeOrderDetailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 获取订单详情-积分
    private String url_getOrderScoreDetail; // url
    private Integer orderId ; // 订单id
    private String type = "4"; // 订单类型
    private String status ; // 订单状态
    private HashMap<String, String> paramsMap_getOrderScoreDetail = new HashMap<String, String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_exchange_order_detail);
        ...
        // 用户id
        userId = (String) SPUtils.get(ScoreExchangeOrderDetailActivity.this, "userId", "");
...
//                deleteOrder();
            ...
            case R.id.tv_comment: // 评价
                Intent intent = new Intent(ScoreExchangeOrderDetailActivity.this, CommentActivity.class);
            ...
            case R.id.tv_go_to_pay: // 去支付
                if (totalAmount != null && totalAmount!= 0){
                    ...
                    Intent intent1 = new Intent(ScoreExchangeOrderDetailActivity.this, OrderPaymentActivity.class);
            ...
            case R.id.tv_share_order: // 分享订单
                if (TextUtils.isEmpty(url)){
                    ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, "分享链接为空！");
                    return;
                }
                // 分享
            ...
            case R.id.rl_wx_chat: // 微信聊天
                WRKShareUtil.getInstance(this).shareUrlToWx(url, "测试分享",
                        "测试分享", "http://bmob-cdn-6725.b0.upaiyun.com/2019/06/10/7452c777409eb675802107e77cc63eca.jpg",
    ...
    //  获取订单详情-积分
    private void getOrderScoreDetail(){
        paramsMap_getOrderScoreDetail.put("orderId", orderId + "");
        url_getOrderScoreDetail = Constants.baseUrl + Constants.url_getOrderScoreDetail;
        Okhttp3Utils.getAsycRequest(url_getOrderScoreDetail, paramsMap_getOrderScoreDetail, new ResultCallback() {
            @Override
            public void onFailure(Exception e) {
                ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, "服务器未响应！");
            }
            ...
            public void onResponse(Object response) {
                if (response != null) {
                    ...
                    if (resultInfo.getCode() == 800) {
                        ...
                        Glide.with(ScoreExchangeOrderDetailActivity.this).load(listImg)
//                    .skipMemoryCache(true)
                        ...
                        // 积分抵扣
                        Double score = data_jsonObject.getDouble("score");
                        tv_score_deduction.setText(score + "");
                        // 运费
                        ...
                        ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, resultInfo.getMessage());
                    }
                } else {
                    ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, "服务器返回数据为空！");
                }
            }
        });
    }
        ...
        Okhttp3Utils.getAsycRequest(url_shareOrderAddScore, paramsMap_shareOrderAddScore, new ResultCallback() {
            ...
            public void onResponse(Object response) {
                if (response != null) {
                    ...
                    ResultInfo resultInfo = JSON.parseObject(str_response, ResultInfo.class);
                    if (resultInfo.getCode() == 800) {
                        ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, "分享成功！");
                    } else {
                        ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, resultInfo.getMessage());
                    }
                } else {
        ...
        Okhttp3Utils.getAsycRequest(url_changeOrderStatus, paramsMap_changeOrderStatus, new ResultCallback() {
            ...
            public void onResponse(Object response) {
                if (response != null) {
                    ...
                    ResultInfo resultInfo = JSON.parseObject(str_response, ResultInfo.class);
                    if (resultInfo.getCode() == 800) {
                        ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, "签收成功！");
                        setResult(1, intent);
                        finish();
                    } else {
                        ToastUtils.showShort(ScoreExchangeOrderDetailActivity.this, resultInfo.getMessage());
