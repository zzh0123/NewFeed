...
public class HalfPriceOrderDetailActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // 获取订单详情-半价
    private String url_getOrderHalfDetail; // url
    private Integer orderId ; // 订单id
    private String type = "3"; // 订单类型
    private String status ; // 订单状态
    private HashMap<String, String> paramsMap_getOrderHalfDetail = new HashMap<String, String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 用户id
        userId = (String) SPUtils.get(HalfPriceOrderDetailActivity.this, "userId", "");
        // 用户名
        userName = (String) SPUtils.get(HalfPriceOrderDetailActivity.this, "userName", "");
        initView();
        getOrderHalfDetail();
    }
...
//                deleteOrder();
            ...
            case R.id.tv_comment: // 评价
                Intent intent = new Intent(HalfPriceOrderDetailActivity.this, CommentActivity.class);
            ...
            case R.id.tv_go_to_pay: // 去支付
                if (totalAmount != null && totalAmount!= 0){
                    Double money = totalAmount + freight;
                    LogUtils.i("--money--", "--money--" + money);
                    String orderType = "半价订单结算";
                    Intent intent1 = new Intent(HalfPriceOrderDetailActivity.this, OrderPaymentActivity.class);
            ...
            case R.id.tv_share_order: // 分享订单
                if (TextUtils.isEmpty(url)){
                    ToastUtils.showShort(HalfPriceOrderDetailActivity.this, "分享链接为空！");
                    return;
                }
                // 分享
            ...
            case R.id.rl_wx_chat: // 微信聊天
                String title = userName + "在慧合牧场营养app上购买了半价饲料" + commodityName + "," + buyCount+ "包，合计金额" + totalAmount;
                String title_sub = "慧合半价饲料试用，一次试用，千百倍成本节约";
            ...
            case R.id.rl_wx_friend_circle: // 微信朋友圈
                String title1 = userName + "在慧合牧场营养app上购买了半价饲料" + commodityName + "," + buyCount + "包，合计金额" + totalAmount;
                String title_sub2 = "慧合半价饲料试用，一次试用，千百倍成本节约";
    ...
    private void getOrderHalfDetail(){
        paramsMap_getOrderHalfDetail.put("orderId", orderId + "");
        url_getOrderHalfDetail = Constants.baseUrl + Constants.url_getOrderHalfDetail;
        Okhttp3Utils.getAsycRequest(url_getOrderHalfDetail, paramsMap_getOrderHalfDetail, new ResultCallback() {
            @Override
            ...
            public void onResponse(Object response) {
                if (response != null) {
                    ...
                    if (resultInfo.getCode() == 800) {
                        ...
                        Glide.with(HalfPriceOrderDetailActivity.this).load(listImg)
